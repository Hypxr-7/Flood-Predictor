...
var meanLST = LST_Day.mean().clip(sindh);
...
var meanNDVI = NDVI.mean().clip(sindh);
...
var meanPrecipitation = precipitation.mean().clip(sindh);
...
var meanNDSI = NDSI.mean().clip(sindh);
